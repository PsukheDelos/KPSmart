...
import kps.frontend.gui.map.layer.shape.ShapeFile;
...
public class VMAP2Shape {
    ...
    public void writeShapeFile(String shapeFileName, OMGraphicList graphics) {
        try {
            ...
            // Using kps.frontend.gui.map.dataAccess.shape package to write
            // shape file:
            EsriShapeExport ese = new EsriShapeExport(graphics, (Projection) null, shapeFileName);
            ese.export();

            // Instead of using kps.frontend.gui.map.layer.shape package to
            // write shape file:
    ...
    public static void main(String args[]) {
        ...
        kps.frontend.gui.map.util.Debug.init(System.getProperties());

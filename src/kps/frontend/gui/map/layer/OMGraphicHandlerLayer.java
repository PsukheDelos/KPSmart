...
import kps.frontend.gui.map.PropertyConsumer;
import kps.frontend.gui.map.event.InfoDisplayEvent;
import kps.frontend.gui.map.event.LayerStatusEvent;
import kps.frontend.gui.map.event.MapMouseEvent;
import kps.frontend.gui.map.event.MapMouseListener;
import kps.frontend.gui.map.event.ProjectionEvent;
import kps.frontend.gui.map.layer.policy.ProjectionChangePolicy;
import kps.frontend.gui.map.layer.policy.RenderPolicy;
import kps.frontend.gui.map.layer.policy.StandardPCPolicy;
import kps.frontend.gui.map.layer.policy.StandardRenderPolicy;
import kps.frontend.gui.map.omGraphics.FilterSupport;
import kps.frontend.gui.map.omGraphics.OMAction;
import kps.frontend.gui.map.omGraphics.OMGraphic;
import kps.frontend.gui.map.omGraphics.OMGraphicHandler;
import kps.frontend.gui.map.omGraphics.OMGraphicList;
import kps.frontend.gui.map.omGraphics.event.GestureResponsePolicy;
import kps.frontend.gui.map.omGraphics.event.MapMouseInterpreter;
import kps.frontend.gui.map.omGraphics.event.StandardMapMouseInterpreter;
...
import kps.frontend.gui.map.util.ISwingWorker;
import kps.frontend.gui.map.util.PaletteHelper;
import kps.frontend.gui.map.util.PooledSwingWorker;
 ...
 * kps.frontend.gui.map.layer.policy.ResetListPCPolicy, or at least clear out the old
 ...
 *     layer.pcp.class=kps.frontend.gui.map.layer.policy.StandardPCPolicy
 *    
 *     layer.renderPolicy=srp
 *     layer.srp.class=kps.frontend.gui.map.layer.policy.StandardRenderPolicy
 *     # or
 *     layer.renderPolicy=ta
 *     layer.ta.class=kps.frontend.gui.map.layer.policy.RenderingHintsRenderPolicy
...
public class OMGraphicHandlerLayer extends Layer implements GestureResponsePolicy, OMGraphicHandler {
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.OMGraphicHandlerLayer");
     ...
     * 
     * @see kps.frontend.gui.map.layer.policy.ProjectionChangePolicy
     * @see kps.frontend.gui.map.layer.policy.StandardPCPolicy
     * @see kps.frontend.gui.map.layer.policy.ListResetPCPolicy
     */
     ...
     * 
     * @see kps.frontend.gui.map.layer.policy.StandardRenderPolicy
     * @see kps.frontend.gui.map.layer.policy.BufferedImageRenderPolicy
     * @see kps.frontend.gui.map.layer.policy.RenderingHintsRenderPolicy
     */
    ...
    /**
     * @see kps.frontend.gui.map.omGraphics.OMGraphicHandler#filter(Shape, boolean).
     */
     ...
     * 
     * @see kps.frontend.gui.map.omGraphics.OMGraphicHandler#supportsSQL().
     */
    ...
    public Properties getPropertyInfo(Properties list) {
        ...
        PropUtils.setI18NPropertyInfo(i18n, list, OMGraphicHandlerLayer.class, ConsumeEventsProperty, "Consume mouse events", "Flag that tells the layer to consume mouse events, or let other layers use them as well.", "kps.frontend.gui.map.util.propertyEditor.OnOffPropertyEditor");
        ...
        PropUtils.setI18NPropertyInfo(i18n, list, OMGraphicHandlerLayer.class, InterruptableProperty, "Interruptable", "Flat to set whether the layer should immediately stop performing current work when the projection changes.", "kps.frontend.gui.map.util.propertyEditor.YesNoPropertyEditor");

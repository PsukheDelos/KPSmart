...
import kps.frontend.gui.map.dataAccess.cgm.CGM;
import kps.frontend.gui.map.dataAccess.cgm.CGMDisplay;
...
import kps.frontend.gui.map.io.CSVFile;
import kps.frontend.gui.map.io.FormatException;
...
import kps.frontend.gui.map.omGraphics.OMRasterObject;
 ...
 * 
 * @see kps.frontend.gui.map.omGraphics.OMGraphic
 */
public class VPFAutoFeatureGraphicWarehouse
        implements VPFFeatureWarehouse, PropertyConsumer {

    protected static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.vpf.VPFAutoFeatureGraphicWarehouse");
     ...
     * (non-Javadoc)
     * 
     * @see kps.frontend.gui.map.PropertyConsumer#setProperties(java.util.Properties)
     */
     ...
     * (non-Javadoc)
     * 
     * @see kps.frontend.gui.map.PropertyConsumer#getProperties(java.util.Properties)
     */
     ...
     * 
     * @see
     * kps.frontend.gui.map.PropertyConsumer#getPropertyInfo(java.util.Properties)
     */
    public Properties getPropertyInfo(Properties list) {
        ...
        PropUtils.setI18NPropertyInfo(i18n, list, VPFAutoFeatureGraphicWarehouse.class, SYMBOL_LOOKUP_FILE_PROPERTY,
                                      ...
                                      "kps.frontend.gui.map.util.propertyEditor.FilePropertyEditor");
        ...
        PropUtils.setI18NPropertyInfo(i18n, list, VPFAutoFeatureGraphicWarehouse.class, CGM_DIR_PROPERTY, "CGM Directory Path",
                                      ...
                                      "kps.frontend.gui.map.util.propertyEditor.DirectoryPropertyEditor");
     ...
     * (non-Javadoc)
     * 
     * @see kps.frontend.gui.map.PropertyConsumer#setPropertyPrefix(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see kps.frontend.gui.map.PropertyConsumer#getPropertyPrefix()
     */
     ...
     * (non-Javadoc)
     * 
     * @see kps.frontend.gui.map.layer.vpf.VPFWarehouse#resetForCAT()
     */
     ...
     * 
     * @see
     * kps.frontend.gui.map.layer.vpf.VPFWarehouse#getGUI(kps.frontend.gui.map.layer.vpf
     ...
     * (non-Javadoc) NOOP
     * 
     * @see kps.frontend.gui.map.layer.vpf.VPFWarehouse#getFeatures()
     */
    ...
    protected static abstract class FeaturePriorityHolder {
        ...
        protected static class Basic
             ...
             * (non-Javadoc)
             * 
             * @see kps.frontend.gui.map.layer.vpf.VPFAutoFeatureGraphicWarehouse.

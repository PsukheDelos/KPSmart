...
import kps.frontend.gui.map.event.CenterListener;
import kps.frontend.gui.map.event.CenterSupport;
import kps.frontend.gui.map.event.MapMouseListener;
import kps.frontend.gui.map.event.OMEvent;
import kps.frontend.gui.map.event.OMEventSelectionCoordinator;
import kps.frontend.gui.map.gui.event.AbstractEventPresenter;
import kps.frontend.gui.map.gui.event.EventPresenter;
import kps.frontend.gui.map.gui.time.TimeSliderLayer.TimeDrape;
import kps.frontend.gui.map.gui.time.TimelineLayer.SelectionArea.PlayFilterSection;
import kps.frontend.gui.map.layer.OMGraphicHandlerLayer;
import kps.frontend.gui.map.layer.policy.NullProjectionChangePolicy;
...
import kps.frontend.gui.map.omGraphics.OMRaster;
...
import kps.frontend.gui.map.time.Clock;
import kps.frontend.gui.map.time.TimeBounds;
import kps.frontend.gui.map.time.TimeBoundsEvent;
import kps.frontend.gui.map.time.TimeBoundsListener;
import kps.frontend.gui.map.time.TimeEvent;
import kps.frontend.gui.map.time.TimeEventListener;
import kps.frontend.gui.map.time.TimerStatus;
...
public class TimelineLayer extends OMGraphicHandlerLayer implements
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.gui.time.TimelineLayer");
   ...
   public boolean mouseDragged(MouseEvent e) {
    ...
    public static class SelectionArea extends kps.frontend.gui.map.omGraphics.OMRect {
    ...
    protected void setMapBeanMaxScale(boolean setScaleToMax) {
        ...
        MapBean mb = (MapBean) ((MapHandler) getBeanContext()).get(kps.frontend.gui.map.MapBean.class);

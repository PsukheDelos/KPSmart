/* 
 */
package kps.frontend.gui.map.gui.menu;
...
import kps.frontend.gui.map.event.UndoStackTrigger;
...
public class UndoMenuItemStackTrigger
    ...
    * requests.
    * 
    * @see kps.frontend.gui.map.event.UndoStackTrigger#addActionListener(java.awt
    ...
    * 
    * @see kps.frontend.gui.map.event.UndoStackTrigger#removeActionListener(java.
    ...
    * (non-Javadoc)
    * 
    * @see kps.frontend.gui.map.event.UndoStackTrigger#updateUndoStackStatus(boolean,
    * boolean)
    */

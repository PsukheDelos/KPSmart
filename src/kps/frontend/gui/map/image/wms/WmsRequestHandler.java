...
import kps.frontend.gui.map.image.MapRequestFormatException;
import kps.frontend.gui.map.proj.AspectRatioProjection;
...
import kps.frontend.gui.map.proj.coords.CoordinateReferenceSystem;
...
import kps.frontend.gui.map.util.http.HttpConnection;
import kps.frontend.gui.map.util.http.IHttpResponse;

...
import kps.frontend.gui.map.image.PNG32ImageFormatter;
import kps.frontend.gui.map.image.SunJPEGFormatter;
import kps.frontend.gui.map.layer.imageTile.MapTileLayer;
 ...
 * 
 * formatter1=.class=kps.frontend.gui.map.image.PNG32ImageFormatter
 * layer1.class=kps.frontend.gui.map.layer.shape.ShapeLayer
 * # ... layer1 properties follow, see layer docs for specific properties for that layer
 * 
 * # Then, for each zoom level
 * zoom1.class=kps.frontend.gui.map.image.ZoomLevelInfo
...
public class MapTileMaker extends ImageServer {
    ...
    public Properties getPropertyInfo(Properties props) {
        ...
        PropUtils.setI18NPropertyInfo(Environment.getI18n(), props, kps.frontend.gui.map.dataAccess.mapTile.MapTileMaker.class, ROOT_DIRECTORY_PROPERTY, "Tile Directory", "Root directory for holding tile files.", "kps.frontend.gui.map.util.propertyEditor.DirectoryPropertyEditor");
        return props;
    }
    ...
    public static void main(String[] args) {
        ...
        kps.frontend.gui.map.util.ArgParser ap = new kps.frontend.gui.map.util.ArgParser("MapTileMaker");

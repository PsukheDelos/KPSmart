 ...
 * <br>
 * unitOfMeasure - any kps.frontend.gui.map.proj.Length instance returned by
...
public class ScaleDisplayLayer
   ...
   protected Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.ScaleDisplayLayer");

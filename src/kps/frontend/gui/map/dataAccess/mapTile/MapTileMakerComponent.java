...
import kps.frontend.gui.map.dataAccess.mapTile.ZoomLevelMakerFace.BoundsObject;
import kps.frontend.gui.map.dataAccess.mapTile.ZoomLevelMakerFace.LayerObject;
import kps.frontend.gui.map.event.LayerEvent;
import kps.frontend.gui.map.event.LayerListener;
import kps.frontend.gui.map.event.MapMouseMode;
import kps.frontend.gui.map.event.MapMouseSupport;
import kps.frontend.gui.map.event.PaintListener;
import kps.frontend.gui.map.event.ProjectionEvent;
import kps.frontend.gui.map.event.ProjectionListener;
import kps.frontend.gui.map.gui.MapPanelChild;
import kps.frontend.gui.map.gui.OMComponentPanel;
import kps.frontend.gui.map.image.ImageServer;
...
import kps.frontend.gui.map.tools.drawing.OMRectLoader;
import kps.frontend.gui.map.util.PropUtils;
import kps.frontend.gui.map.util.TaskService;
 ...
 * tileMakerComp.class=kps.frontend.gui.map.dataAccess.mapTile.MapTileMakerComponent
...
public class MapTileMakerComponent
   ...
   protected Logger logger = Logger.getLogger("kps.frontend.gui.map.dataAccess.mapTile.MapTileMakerComponent");
    ...
    * (non-Javadoc)
    * 
    * @see kps.frontend.gui.map.gui.MapPanelChild#getParentName()
    */
    ...
    * (non-Javadoc)
    * 
    * @see kps.frontend.gui.map.gui.MapPanelChild#getPreferredLocation()
    */
    ...
    * 
    * @see
    * kps.frontend.gui.map.gui.MapPanelChild#setPreferredLocation(java.lang.String)
    */
    ...
    * 
    * @see
    * kps.frontend.gui.map.event.LayerListener#setLayers(kps.frontend.gui.map.event.LayerEvent
    * )
    */
    ...
    * (non-Javadoc)
    * 
    * @see kps.frontend.gui.map.event.PaintListener#listenerPaint(java.awt.Graphics)
    */
    ...
    * 
    * @see
    * kps.frontend.gui.map.event.ProjectionListener#projectionChanged(kps.frontend.gui.map
   ...
   protected class ConfirmationDialog
      ...
      public ConfirmationDialog(Frame frame, Component locationComp, String title, MapTileMakerComponent mapTileMakerComponent) {
         ...
         if (faceCount == 0) {
            ...
            launchProps.put("png.class", "kps.frontend.gui.map.image.PNGImageIOFormatter");

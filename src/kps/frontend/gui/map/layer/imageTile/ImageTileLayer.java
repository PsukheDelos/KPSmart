...
package kps.frontend.gui.map.layer.imageTile;
...
import kps.frontend.gui.map.dataAccess.image.ErrImageTile;
import kps.frontend.gui.map.dataAccess.image.ImageReader;
import kps.frontend.gui.map.dataAccess.image.ImageReaderLoader;
import kps.frontend.gui.map.dataAccess.image.ImageTile;
import kps.frontend.gui.map.event.LayerStatusEvent;
import kps.frontend.gui.map.gui.LayerControlButtonPanel;
import kps.frontend.gui.map.gui.LayersPanel;
import kps.frontend.gui.map.layer.OMGraphicHandlerLayer;
import kps.frontend.gui.map.omGraphics.DrawingAttributes;
...
import kps.frontend.gui.map.proj.Proj;
import kps.frontend.gui.map.tools.icon.BasicIconPart;
import kps.frontend.gui.map.tools.icon.IconPart;
import kps.frontend.gui.map.tools.icon.IconPartList;
import kps.frontend.gui.map.tools.icon.OMIconFactory;
 ...
 * imageTileLayer.geotiff=kps.frontend.gui.map.dataAccess.image.geotiff.GeoTIFFImageReader.Loader
 *                       
...
public class ImageTileLayer extends OMGraphicHandlerLayer {
    ...
    */
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.imageTile.ImageTileLayer");
    ...
    protected void configureImageReaderLoaders() {
        ...
        ImageReaderLoader idl = (ImageReaderLoader) ComponentFactory.create("kps.frontend.gui.map.dataAccess.image.geotiff.GeoTIFFImageReaderLoader");
        ...
        idl = (ImageReaderLoader) ComponentFactory.create("kps.frontend.gui.map.dataAccess.image.WorldFileImageReaderLoader");
        if (idl != null) {
            imageReaderLoaders.add(idl);
        } else {
    ...
    public Properties getPropertyInfo(Properties props) {
        ...
        PropUtils.setI18NPropertyInfo(i18n, props, ImageTileLayer.class, ImageFilePathProperty, "Images", "A list of images or directories to display (separated by ;).", "kps.frontend.gui.map.util.propertyEditor.MultiDirFilePropertyEditor");
        ...
        PropUtils.setI18NPropertyInfo(i18n, props, ImageTileLayer.class, dummyMarker, "Highlight Settings", "Settings for annotations on highlighted images.", "kps.frontend.gui.map.omGraphics.DrawingAttributesPropertyEditor");
    ...
    protected void goTo(ImageTile[] selectedTiles2) {
        if (mapBean == null) {
            ...
            if (bc != null) {
                mapBean = (MapBean) bc.get(kps.frontend.gui.map.MapBean.class);
            }
        }

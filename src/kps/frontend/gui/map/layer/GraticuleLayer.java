...
import kps.frontend.gui.map.MoreMath;
import kps.frontend.gui.map.event.ProjectionEvent;
import kps.frontend.gui.map.layer.policy.BufferedImageRenderPolicy;
...
import kps.frontend.gui.map.proj.Cylindrical;
import kps.frontend.gui.map.proj.GeoProj;
 ...
 *    # class
 *    graticule.class=kps.frontend.gui.map.layer.GraticuleLayer
 *    # name
...
public class GraticuleLayer
   ...
   public Properties getPropertyInfo(Properties properties) {
      ...
      properties.put(TenDegreeColorProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.ColorPropertyEditor");
      ...
      properties.put(FiveDegreeColorProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.ColorPropertyEditor");
      ...
      properties.put(OneDegreeColorProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.ColorPropertyEditor");
      ...
      properties.put(BelowOneDegreeColorProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.ColorPropertyEditor");
      ...
      properties.put(EquatorColorProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.ColorPropertyEditor");
      ...
      properties.put(DateLineColorProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.ColorPropertyEditor");
      ...
      properties.put(SpecialLineColorProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.ColorPropertyEditor");
      ...
      properties.put(TextColorProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.ColorPropertyEditor");
      ...
      properties.put(ShowOneAndFiveProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.TrueFalsePropertyEditor");
      ...
      properties.put(ShowBelowOneProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.TrueFalsePropertyEditor");
      ...
      properties.put(ShowRulerProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.TrueFalsePropertyEditor");

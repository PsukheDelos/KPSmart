...
import kps.frontend.gui.map.geo.ExtentIndex.ArrayListExtentIndexImpl;
import kps.frontend.gui.map.geo.GeoExtent;
...
import kps.frontend.gui.map.geo.MatchCollector;
import kps.frontend.gui.map.geo.MatchFilter;
import kps.frontend.gui.map.geo.MatchParameters;

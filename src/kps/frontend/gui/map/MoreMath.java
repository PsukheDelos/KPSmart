...
public class MoreMath {
     ...
     * kps.frontend.gui.map.util.Debug.output("32767="+BuildShortLE(b, 0));
     * b[0] = (byte)0x7f; b[1] = (byte)0xff;
     * kps.frontend.gui.map.util.Debug.output("32767="+BuildShortBE(b, 0));
     * b[1] = (byte)0xff; b[2] = (byte)0xff; b[3] = (byte)0xff;
     * kps.frontend.gui.map.util.Debug.output("2147483647="+BuildIntegerBE(b,
     * 0));
     * kps.frontend.gui.map.util.Debug.output("maxuint="+signedToLong(0xffffffff)); }
     */
}
...
import kps.frontend.gui.map.tools.beanbox.BeanBoxHandler;

/**
 * An OpenMap Layer for displaying
 * {@link kps.frontend.gui.map.layer.beanbox.SimpleBeanObject}beans.
 * This class an example of an openmap layer that contains an instance
 * of the {@link kps.frontend.gui.map.tools.beanbox.BeanBox}class. This
 * layer maintains a reference to an instance of
 * {@link kps.frontend.gui.map.layer.beanbox.SimpleBeanBox}class which
 * is a sample implementation of the
 * {@link kps.frontend.gui.map.tools.beanbox.BeanBox}class. The
 * {@link kps.frontend.gui.map.layer.beanbox.SimpleBeanBox}class
 * manages the set of
 * {@link kps.frontend.gui.map.layer.beanbox.SimpleBeanObject}beans
...
public class SimpleBeanLayer extends Layer implements BeanBoxHandler {
     ...
     *         {@link kps.frontend.gui.map.layer.beanbox.SimpleBeanBox}

...
public class TimeSliderLayer
   ...
   protected static Logger logger = Logger.getLogger("kps.frontend.gui.map.gui.time.TimeSliderLayer");
   ...
   public TimeSliderLayer(boolean realTimeMode) {
      ...
      // received.
      setProjectionChangePolicy(new kps.frontend.gui.map.layer.policy.StandardPCPolicy(this, false));
   ...
   class LabelPanel
         extends JPanel
         implements kps.frontend.gui.map.gui.MapPanelChild {

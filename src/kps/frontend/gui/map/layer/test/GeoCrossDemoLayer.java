 ...
 * 
 * <pre>
 *          geocross.class=kps.frontend.gui.map.layer.test.GeoCrossDemoLayer
 *          geocross.prettyName=GEO Cross Demonstration
 *          geocross.editor=kps.frontend.gui.map.layer.editor.DrawingEditorTool
 *          geocross.showAttributes=true
 *          geocross.loaders=lines
 *          geocross.mouseModes=Gestures
 *          geocross.lines.class=kps.frontend.gui.map.tools.drawing.OMLineLoader
 * </pre>
 * 
 * @author dietrick
 */

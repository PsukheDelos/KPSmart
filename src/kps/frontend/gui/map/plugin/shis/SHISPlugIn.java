...
package kps.frontend.gui.map.plugin.shis;
 ...
 * pluginlayer.class=kps.frontend.gui.map.plugin.PlugInLayer
 * pluginlayer.prettyName=Whatever
 * pluginlayer.plugin=kps.frontend.gui.map.plugin.shis.SHISPlugIn
...
public class SHISPlugIn extends WebImagePlugIn implements ImageServerConstants {
    ...
    public void setProperties(String prefix, Properties setList) {
        ...
        if (path == null) {
            path = kps.frontend.gui.map.Environment.OpenMapPrefix; // "openmap"
        }

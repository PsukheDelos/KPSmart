...
public abstract class AbstractMapTileCoordinateTransform implements MapTileCoordinateTransform {
     ...
     * 
     * @see
     * kps.frontend.gui.map.dataAccess.mapTile.MapTileCoordinateTransform#latLonToTileUV
     ...
     * 
     * @see
     * kps.frontend.gui.map.dataAccess.mapTile.MapTileCoordinateTransform#tileUVToLatLon
     * (java.awt.geom.Point2D, int)
     */

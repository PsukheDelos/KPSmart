...
import kps.frontend.gui.map.tools.beanbox.BeanBox;
import kps.frontend.gui.map.tools.beanbox.BeanContainer;

/**
 * SimpleBeanBox is a sample implementation of the
 * {@link kps.frontend.gui.map.tools.beanbox.BeanBox}class. SimpleBeanBox manages
...
public class SimpleBeanBox extends BeanBox implements MapMouseListener {
     ...
     * <code>kps.frontend.gui.map.tools.beanbox.BeanBoxDnDCatcher</code> class to add
     ...
     * the <code>kps.frontend.gui.map.tools.beanbox.BeanBoxDnDCatcher</code> class to
     ...
     * <code>kps.frontend.gui.map.tools.beanbox.BeanBoxDnDCatcher</code> class to set
     ...
     * <code>kps.frontend.gui.map.tools.beanbox.BeanContainer</code> interface.
     * 
     ...
     * <code>kps.frontend.gui.map.tools.beanbox.BeanContainer</code> that encloses
     ...
     * <code>kps.frontend.gui.map.tools.beanbox.BeanContainer</code> and which lies
     ...
     * by the <code>kps.frontend.gui.map.tools.beanbox.BeanBoxDnDCatcher</code>
     ...
     * <code>kps.frontend.gui.map.tools.beanbox.GenericPropertySheet</code> when the

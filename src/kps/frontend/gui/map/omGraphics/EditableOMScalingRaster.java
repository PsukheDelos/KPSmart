...
import kps.frontend.gui.map.omGraphics.editable.ScalingRasterStateMachine;
...
public class EditableOMScalingRaster extends EditableOMGraphic {
    ...
    public void createGraphic(GraphicAttributes ga) {
        ...
        if (!Environment.isApplet()) {
            pathToFile = kps.frontend.gui.map.util.FileUtils.getFilePathToOpenFromUser("Choose Image File for Raster");
        } else {

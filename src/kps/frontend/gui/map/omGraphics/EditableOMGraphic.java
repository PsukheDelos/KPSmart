...
public abstract class EditableOMGraphic
    ...
    *
    * @see kps.frontend.gui.map.util.stateMachine.StateMachine
    */
    ...
    *
    * @param proj kps.frontend.gui.map.proj.Projection
    * @return true
    */
...
//      palette.add(toolbar);
   ...
   public static class OMGraphicUndoEvent
       ...
       * (non-Javadoc)
       *
       * @see kps.frontend.gui.map.event.UndoEvent#getDescription()
       */
       ...
       * (non-Javadoc)
       *
       * @see kps.frontend.gui.map.event.UndoEvent#setState()
       */

 ...
 * </pre>
 * 
 * @see kps.frontend.gui.map.layer.location.LocationHandler
...
public abstract class AbstractLocationHandler implements LocationHandler {
    ...
    protected static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.location.LocationHandler");

...
package kps.frontend.gui.map.dataAccess.image.geotiff;
...
public class GeoTIFFModelFactory {
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.dataAccess.image.geotiff.GeoTIFFModelFactory");

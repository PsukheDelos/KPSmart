 ...
 * shapeLayer.class=kps.frontend.gui.map.layer.shape.ShapeLayer
...
public class ShapeLayer extends OMGraphicHandlerLayer implements ActionListener,
   ...
   public static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.shape.ShapeLayer");
    ...
    public Properties getPropertyInfo(Properties list) {
        ...
        PropUtils.setI18NPropertyInfo(
                                      ...
                                      "kps.frontend.gui.map.omGraphics.DrawingAttributesPropertyEditor");

...
import kps.frontend.gui.map.gui.menu.AboutMenuItem;
import kps.frontend.gui.map.gui.menu.LoadPropertiesMenuItem;
import kps.frontend.gui.map.gui.menu.MapBeanPrinterMenuItem;
import kps.frontend.gui.map.gui.menu.QuitMenuItem;
import kps.frontend.gui.map.gui.menu.SaveAsMenu;
import kps.frontend.gui.map.gui.menu.SavePropertiesMenuItem;

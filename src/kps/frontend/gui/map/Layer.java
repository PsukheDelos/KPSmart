...
import kps.frontend.gui.map.event.InfoDisplayListener;
import kps.frontend.gui.map.event.LayerStatusEvent;
import kps.frontend.gui.map.event.LayerStatusListener;
import kps.frontend.gui.map.event.ListenerSupport;
import kps.frontend.gui.map.event.MapMouseListener;
import kps.frontend.gui.map.event.ProjectionEvent;
import kps.frontend.gui.map.event.ProjectionListener;
import kps.frontend.gui.map.gui.ScrollPaneWindowSupport;
import kps.frontend.gui.map.gui.WindowSupport;
import kps.frontend.gui.map.proj.Projection;
import kps.frontend.gui.map.proj.coords.GeoCoordTransformation;
...
import kps.frontend.gui.map.util.propertyEditor.Inspector;
 ...
 * 
 * public void projectionChanged(kps.frontend.gui.map.event.ProjectionEvent pe) {
 ...
 * </pre>
 * 
 * @see kps.frontend.gui.map.event.ProjectionListener
 * @see kps.frontend.gui.map.event.ProjectionEvent
 * @see kps.frontend.gui.map.PropertyConsumer
 */
public abstract class Layer
    ...
    public void setName(String name) {
        ...
        if (bc instanceof MapHandler) {
            LayerHandler lh = (LayerHandler) ((MapHandler) bc).get("kps.frontend.gui.map.LayerHandler");
    ...
    public Properties getPropertyInfo(Properties list) {
        ...
        list.put("class.editor", "kps.frontend.gui.map.util.propertyEditor.NonEditablePropertyEditor");
        ...
        list.put(PrettyNameProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.NonEditablePropertyEditor");
        ...
        list.put(AutoPaletteProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.YesNoPropertyEditor");
        ...
        list.put(AddAsBackgroundProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.YesNoPropertyEditor");
        ...
        list.put(RemovableProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.YesNoPropertyEditor");
        ...
        list.put(AddToBeanContextProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.YesNoPropertyEditor");
    ...
    public void showPalette() {
        ...
        if (ws != null) {
            ...
            if (mh != null) {
                ...
                if (frame == null) {
                    MapBean mapBean = (MapBean) mh.get("kps.frontend.gui.map.MapBean");
                    if (mapBean == null) {

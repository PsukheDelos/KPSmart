...
import kps.frontend.gui.map.omGraphics.OMGraphicAdapter;
...
public abstract class Location
    ...
    protected static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.location.Location");
    ...
    public static void main(String[] args) {
        if (args.length < 1) {
            logger.info("  usage: java kps.frontend.gui.map.layer.location.Location <[NSWE]XXXXXXXX>");
            return;
        }

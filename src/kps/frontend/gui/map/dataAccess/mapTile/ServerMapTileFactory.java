...
import kps.frontend.gui.map.dataAccess.mapTile.StandardMapTileFactory.TilePathBuilder;
...
public class ServerMapTileFactory extends StandardMapTileFactory implements MapTileFactory,
    ...
    public Properties getPropertyInfo(Properties list) {
        ...
        PropUtils.setI18NPropertyInfo(i18n, list, kps.frontend.gui.map.dataAccess.mapTile.StandardMapTileFactory.class, LOCAL_CACHE_ROOT_DIR_PROPERTY, "Local Cache Tile Directory", "Root directory containing image tiles retrieved from image server.", "kps.frontend.gui.map.util.propertyEditor.DirectoryPropertyEditor");
        return list;
    }

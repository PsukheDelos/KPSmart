...
package kps.frontend.gui.map.layer.rpf;
...
public class RpfViewAttributes implements RpfConstants, PropertyConsumer, Serializable {
    ...
    public Properties getPropertyInfo(Properties list) {
        ...
        list.put(NumColorsProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.ComboBoxPropertyEditor");
        ...
        list.put(ShowMapsProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.OnOffPropertyEditor");
        ...
        list.put(ShowInfoProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.OnOffPropertyEditor");
        ...
        list.put(ScaleImagesProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.OnOffPropertyEditor");
        ...
        list.put(AutoFetchAttributeProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.OnOffPropertyEditor");
        ...
        list.put(ColormodelProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.ComboBoxPropertyEditor");

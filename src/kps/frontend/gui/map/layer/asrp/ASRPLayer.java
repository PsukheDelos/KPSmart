...
package kps.frontend.gui.map.layer.asrp;
...
import kps.frontend.gui.map.dataAccess.asrp.ASRPConstants;
import kps.frontend.gui.map.dataAccess.asrp.ASRPDirectory;
import kps.frontend.gui.map.dataAccess.asrp.ASRPDirectoryHandler;
import kps.frontend.gui.map.dataAccess.asrp.TransmittalHeaderFile;
...
public class ASRPLayer extends OMGraphicHandlerLayer implements
    ...
    public Properties getPropertyInfo(Properties props) {
        ...
        props.put(THFProperty + ScopedEditorProperty,
                "kps.frontend.gui.map.util.propertyEditor.MultiDirFilePropertyEditor");
        ...
        props.put(ASRPDirectoryProperty + ScopedEditorProperty,
                "kps.frontend.gui.map.util.propertyEditor.MultiDirectoryPropertyEditor");
    ...
    public Component getGUI() {
        if (guiPanel == null) {
            ...
            interString = i18n.get(ASRPLayer.class,
                    "coveragePanelTitle",
                    "Coverage Controls");
            JPanel covPanel = kps.frontend.gui.map.util.PaletteHelper.createVerticalPanel(interString);

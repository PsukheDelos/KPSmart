...
package kps.frontend.gui.map.util.cacheHandler;
 ...
 * kps.frontend.gui.map.layer.util.cacheHandler package components, this CacheHandler
...
public abstract class CacheHandler {
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.util.cacheHandler.CacheHandler");

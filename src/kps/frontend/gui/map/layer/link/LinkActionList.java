...
package kps.frontend.gui.map.layer.link;
...
public class LinkActionList implements LinkActionConstants,
     ...
     * @throws IOException
     * @see kps.frontend.gui.map.layer.link.LinkBitmap
     */
     ...
     * @param graphicUpdateMask the mask describing the graphic update.
     * @throws IOException
     * @see kps.frontend.gui.map.layer.link.LinkCircle
     */
     ...
     * @param properties description of drawing attributes.
     * @param graphicUpdateMask the mask describing the graphic update.
     * @see kps.frontend.gui.map.layer.link.LinkGrid
     * @throws IOException
     */
     ...
     * @param graphicUpdateMask the mask describing the graphic update.
     * @throws IOException
     * @see kps.frontend.gui.map.layer.link.LinkLine
     */
     ...
     * @see kps.frontend.gui.map.layer.link.LinkRaster
     */
     ...
     * @param graphicUpdateMask the mask describing the graphic update.
     * @throws IOException
     * @see kps.frontend.gui.map.layer.link.LinkRectangle
     */
     ...
     * @param graphicUpdateMask the mask describing the graphic update.
     * @throws IOException
     * @see kps.frontend.gui.map.layer.link.LinkPoint
     */
     ...
     * @param graphicUpdateMask the mask describing the graphic update.
     * @throws IOException
     * @see kps.frontend.gui.map.layer.link.LinkPoly
     */
     ...
     * @param graphicUpdateMask the mask describing the graphic update.
     * @throws IOException
     * @see kps.frontend.gui.map.layer.link.LinkText
     */

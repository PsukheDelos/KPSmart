...
import kps.frontend.gui.map.time.RealTimeHandler;
import kps.frontend.gui.map.time.TimeBounds;
import kps.frontend.gui.map.time.TimeBoundsHandler;
import kps.frontend.gui.map.time.TimeBoundsProvider;
...
public class EventLayer extends OMGraphicHandlerLayer implements
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.event.EventLayer");

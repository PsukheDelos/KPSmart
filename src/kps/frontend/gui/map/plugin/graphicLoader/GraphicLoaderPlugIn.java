...
package kps.frontend.gui.map.plugin.graphicLoader;
...
import kps.frontend.gui.map.graphicLoader.GraphicLoader;
...
import kps.frontend.gui.map.plugin.OMGraphicHandlerPlugIn;
 ...
 * <pre>
 * 
 *  graphicLoaderPlugIn.class=kps.frontend.gui.map.plugin.graphicLoader.GraphicLoaderPlugIn
 ...
 * 
 * <LI>You can add a
 * kps.frontend.gui.map.plugin.graphicLoader.GraphicLoaderConnector to the

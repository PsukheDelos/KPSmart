...
package kps.frontend.gui.map.omGraphics.event;
 ...
 * 
 * @see kps.frontend.gui.map.omGraphics.event.MapMouseInterpreter
 * @see kps.frontend.gui.map.omGraphics.event.StandardMapMouseInterpreter
 * @see kps.frontend.gui.map.layer.OMGraphicHandlerLayer
 */

...
public class ImageMaster {
    ...
    public static void printHelp() {
        Debug.output("");
        Debug.output("usage: java kps.frontend.gui.map.image.ImageMaster [-file <properties file> || -url <properties file>] [-masterprops || -serverprops");
    ...
    public static void printServerProps() {
        ...
        Debug.output("");
        Debug.output("layer1.class=<kps.frontend.gui.map.layer.ShapeLayer");

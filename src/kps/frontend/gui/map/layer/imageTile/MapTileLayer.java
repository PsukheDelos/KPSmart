...
import kps.frontend.gui.map.dataAccess.mapTile.MapTileFactory;
import kps.frontend.gui.map.dataAccess.mapTile.MapTileRequester;
import kps.frontend.gui.map.dataAccess.mapTile.ServerMapTileFactory;
import kps.frontend.gui.map.dataAccess.mapTile.StandardMapTileFactory;
 ...
 * <pre>
 * 
 * tiles.class=kps.frontend.gui.map.layer.imageTile.MapTileLayer
 * tiles.prettyName=TILES
 * tiles.tileFactory=kps.frontend.gui.map.dataAccess.mapTile.StandardMapTileFactory
 ...
 * tiles.mapTileTransform=kps.frontend.gui.map.dataAccess.mapTile.OSMMapTileCoordinateTransform, or kps.frontend.gui.map.dataAccess.mapTile.TMSMapTileCoordinateTransform
 * 
 * </pre>
 * 
 ...
 * tiles.class=kps.frontend.gui.map.layer.imageTile.MapTileLayer
 * tiles.prettyName=TILES
 * tiles.tileFactory=kps.frontend.gui.map.dataAccess.mapTile.ServerMapTileFactory
 ...
 * tiles.cacheSize=the number of mapTiles the factory should hold on to. The default is 100.
 * # transform for naming convention of tiles default is OSMMapTileCoordinateTransform, but it depends on the source of tiles.  GDAL is TSMMapTileCoordinateTransform
 * mapTileTransform=kps.frontend.gui.map.dataAccess.mapTile.OSMMapTileCoordinateTransform, or kps.frontend.gui.map.dataAccess.mapTile.TMSMapTileCoordinateTransform
 * 
 * </pre>
 * 
 ...
 * mapTileTransform=kps.frontend.gui.map.dataAccess.mapTile.TMSMapTileCoordinateTransform
...
public class MapTileLayer extends OMGraphicHandlerLayer implements MapTileRequester {
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.imageTile.TileLayer");
    ...
    public MapTileLayer() {
        setRenderPolicy(new kps.frontend.gui.map.layer.policy.BufferedImageRenderPolicy(this));
     ...
     * (non-Javadoc)
     * 
     * @see kps.frontend.gui.map.dataAccess.mapTile.MapTileRequestor#shouldContinue()
     */
     ...
     * (non-Javadoc)
     * 
     * @see kps.frontend.gui.map.dataAccess.mapTile.MapTileRequestor#listUpdated()
     */

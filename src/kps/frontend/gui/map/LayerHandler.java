...
import kps.frontend.gui.map.event.LayerConfigurationListener;
import kps.frontend.gui.map.event.LayerConfigurationListenerSupport;
import kps.frontend.gui.map.event.LayerEvent;
import kps.frontend.gui.map.event.LayerListener;
import kps.frontend.gui.map.event.LayerSupport;
import kps.frontend.gui.map.plugin.PlugIn;
import kps.frontend.gui.map.plugin.PlugInLayer;
 ...
 *             marker1.class=kps.frontend.gui.map.layer.GraticuleLayer
 *             marker1.prettyName=Graticule Layer
 *             # false is default
 *             marker1.addToBeanContext=false
 *           &lt;p/&gt;
 *             marker2.class=kps.frontend.gui.map.layer.shape.ShapeLayer
...
public class LayerHandler extends OMComponent implements SoloMapComponent, Serializable {
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.LayerHandler");
    ...
    public void removeLayer(Layer layer) {
        if (layer != null && layer.isRemovable()) {
            ...
            if (layer != null) {
                ...
                throw new kps.frontend.gui.map.util.HandleError("LayerHandler commanded to delete a layer ("
    ...
    public Properties getPropertyInfo(Properties props) {
        ...
        props.put(SynchronousThreadingProperty + EditorProperty, "kps.frontend.gui.map.util.propertyEditor.YesNoPropertyEditor");

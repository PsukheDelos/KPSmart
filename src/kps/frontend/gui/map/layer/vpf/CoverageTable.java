...
import kps.frontend.gui.map.layer.vpf.VPFAutoFeatureGraphicWarehouse.FeaturePriorityHolder;
...
public class CoverageTable {
    ...
    protected final static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.vpf.CoverageTable");

...
package kps.frontend.gui.map.gui.event;
...
import kps.frontend.gui.map.event.OMEventComparator;
import kps.frontend.gui.map.event.OMEventHandler;
import kps.frontend.gui.map.event.OMEventSelectionCoordinator;
import kps.frontend.gui.map.event.OMEventSelectionListener;
import kps.frontend.gui.map.gui.time.TimePanel;
 ...
 * 
 * <pre>
 * eventListPresenter.class=kps.frontend.gui.map.gui.event.EventListPresenter
 * eventListPresenter.prettyName=List
 * eventListPresenter.cellRendererClass=kps.frontend.gui.map.gui.event.EventListCellRenderer
 ...
 * eventListPresenter.iconPackageClass=kps.frontend.gui.map.gui.event.EventListIconPackage
...
public class EventListPresenter extends AbstractEventPresenter implements
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.gui.event.EventListPresenter");

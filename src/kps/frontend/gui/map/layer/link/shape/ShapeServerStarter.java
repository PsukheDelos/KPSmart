...
import kps.frontend.gui.map.layer.link.LinkServerStarter;
...
public class ShapeServerStarter extends LinkServerStarter {
    ...
    public static void main(String[] argv) {
        ...
        if (pnumber < 0 || shp == null) {
            ...
            System.err.println("Usage: java kps.frontend.gui.map.layer.link.shape.ShapeServerStarter <ShapeFile Name.shp> -port <port number>");
            System.exit(-1);
        }

...
public class OMDistanceLoader extends AbstractToolLoader implements
    ...
    protected String graphicClassName = "kps.frontend.gui.map.omGraphics.OMDistance";

    protected String editableClassName = "kps.frontend.gui.map.omGraphics.EditableOMDistance";

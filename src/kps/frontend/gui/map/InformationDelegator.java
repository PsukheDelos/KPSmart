...
import kps.frontend.gui.map.gui.StatusLightPanel;
import kps.frontend.gui.map.util.Debug;
import kps.frontend.gui.map.util.PropUtils;
import kps.frontend.gui.map.util.WebBrowser;
...
public class InformationDelegator extends OMComponentPanel implements
    ...
    public void displayURL(String url) {
        ...
        try {
            kps.frontend.gui.map.gui.MiniBrowser.display(frame, new URL(url));
    ...
    public void displayBrowserContent(String content) {
        ...
        kps.frontend.gui.map.gui.MiniBrowser.display(frame, "text/html", content);
    }

...
%JAVABIN% -mx64m -Dopenmap.configDir=%OPENMAP_HOME%\share kps.frontend.gui.map.app.OpenMap -properties %OPENMAP_HOME%\src\openmap\com\bbn\openmap\examples\beanbox\openmap.properties

...
package kps.frontend.gui.map.layer.event;
...
import kps.frontend.gui.map.omGraphics.time.TemporalOMGraphic;
import kps.frontend.gui.map.omGraphics.time.TemporalOMGraphicList;
import kps.frontend.gui.map.omGraphics.time.TemporalOMPoint;
import kps.frontend.gui.map.omGraphics.time.TemporalOMScalingIcon;
import kps.frontend.gui.map.omGraphics.time.TemporalPoint;
 ...
 * 
 * <pre>
 *    eventLayer.class=kps.frontend.gui.map.layer.time.EventLayer
 *    eventLayer.importer=kps.frontend.gui.map.layer.time.CSVEventImporter
...
public class CSVEventImporter extends OMComponent implements EventImporter {
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.event.CSVEventImporter");

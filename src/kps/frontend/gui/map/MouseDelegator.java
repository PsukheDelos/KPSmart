...
import kps.frontend.gui.map.event.NullMouseMode;
 ...
 * 
 * @see kps.frontend.gui.map.event.MapMouseMode
 * @see kps.frontend.gui.map.event.AbstractMouseMode
 * @see kps.frontend.gui.map.event.NavMouseMode
 * @see kps.frontend.gui.map.event.SelectMouseMode
 */

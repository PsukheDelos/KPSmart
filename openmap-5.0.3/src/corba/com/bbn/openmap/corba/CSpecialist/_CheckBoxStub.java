...
/**
* com/bbn/openmap/corba/CSpecialist/_CheckBoxStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ./src/corba/com/bbn/openmap/layer/specialist/Specialist.idl
* Tuesday, November 12, 2013 11:07:46 PM EST
*/

public class _CheckBoxStub extends org.omg.CORBA.portable.ObjectImpl implements com.bbn.openmap.corba.CSpecialist.CheckBox
{
  ...
  public com.bbn.openmap.corba.CSpecialist.CheckButton[] buttons ()
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                com.bbn.openmap.corba.CSpecialist.CheckButton $result[] = com.bbn.openmap.corba.CSpecialist.CheckButtonsHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public void buttons (com.bbn.openmap.corba.CSpecialist.CheckButton[] newButtons)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_set_buttons", true);
                com.bbn.openmap.corba.CSpecialist.CheckButtonsHelper.write ($out, newButtons);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  public void selected (String box_label, com.bbn.openmap.corba.CSpecialist.CheckButton button, String uniqueID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("selected", false);
                $out.write_string (box_label);
                com.bbn.openmap.corba.CSpecialist.CheckButtonHelper.write ($out, button);

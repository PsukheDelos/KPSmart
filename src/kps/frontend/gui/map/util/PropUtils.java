...
public class PropUtils {
   ...
   public static Logger logger = Logger.getLogger("kps.frontend.gui.map.util.PropUtils");
    ...
    * i.e. the kps.frontend.gui.map.omGraphics.DrawingAttributesPropertyEditor.
    * 

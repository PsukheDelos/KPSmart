 ...
 * 
 * <pre>
 * eventPanel.class=kps.frontend.gui.map.gui.event.EventPanel
...
public class EventPanel extends OMComponentPanel implements MapPanelChild {
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.gui.event.EventPanel");
    ...
    protected void showFilterInterface() {
        ...
        OpenMapFrame frame = (OpenMapFrame) beanContext.get(kps.frontend.gui.map.gui.OpenMapFrame.class);

...
import kps.frontend.gui.map.gui.menu.MenuList;
...
public class BasicMapPanel
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.gui.MapPanel");
    ...
    protected void createComponents() {
        ...
        Object obj = mh.get(kps.frontend.gui.map.proj.ProjectionFactory.class);
        if (obj == null) {
            Debug.message("basic",

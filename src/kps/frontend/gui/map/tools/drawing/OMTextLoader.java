...
import kps.frontend.gui.map.omGraphics.EditableOMText;
...
public class OMTextLoader extends AbstractToolLoader implements EditToolLoader {
    ...
    protected String textClassName = "kps.frontend.gui.map.omGraphics.OMText";
    ...
    public void init() {
        EditClassWrapper ecw = new EditClassWrapper(textClassName, "kps.frontend.gui.map.omGraphics.EditableOMText", "editabletext.gif", i18n.get(OMTextLoader.class,
                "omtext",
                "Text"));

...
package kps.frontend.gui.map.layer.learn;
 ...
 * override them).
 * 
 * @see kps.frontend.gui.map.layer.OMGraphicHandlerLayer#isHighlightable
 * @see kps.frontend.gui.map.layer.OMGraphicHandlerLayer#highlight
 * @see kps.frontend.gui.map.layer.OMGraphicHandlerLayer#unhighlight
 * @see kps.frontend.gui.map.layer.OMGraphicHandlerLayer#getInfoText
 * @see kps.frontend.gui.map.layer.OMGraphicHandlerLayer#getToolTipText
 * 
 * @see kps.frontend.gui.map.layer.OMGraphicHandlerLayer#isSelectable
 * @see kps.frontend.gui.map.layer.OMGraphicHandlerLayer#select
 * @see kps.frontend.gui.map.layer.OMGraphicHandlerLayer#deselect
 * @see kps.frontend.gui.map.layer.OMGraphicHandlerLayer#getItemsForMapMenu
 * @see kps.frontend.gui.map.layer.OMGraphicHandlerLayer#getItemsForOMGraphicMenu
 * 
 * @see kps.frontend.gui.map.layer.OMGraphicHandlerLayer#receivesMapEvents
 * @see kps.frontend.gui.map.layer.OMGraphicHandlerLayer#mouseOver(MapMouseEvent)
 * @see kps.frontend.gui.map.layer.OMGraphicHandlerLayer#leftClick
 */
public class InteractionLayer extends BasicLayer {
    ...
    public InteractionLayer() {
        ...
        setProjectionChangePolicy(new kps.frontend.gui.map.layer.policy.StandardPCPolicy(this, true));

...
/**
* com/bbn/openmap/corba/CSpecialist/colorTableHelper.java .
...
abstract public class colorTableHelper
{
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = com.bbn.openmap.corba.CSpecialist.CTEntryHelper.type ();
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (com.bbn.openmap.corba.CSpecialist.colorTableHelper.id (), "colorTable", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    com.bbn.openmap.corba.CSpecialist.CTEntry value[] = null;
    int _len0 = istream.read_long ();
    value = new com.bbn.openmap.corba.CSpecialist.CTEntry[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = com.bbn.openmap.corba.CSpecialist.CTEntryHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, com.bbn.openmap.corba.CSpecialist.CTEntry[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      com.bbn.openmap.corba.CSpecialist.CTEntryHelper.write (ostream, value[_i0]);
  }

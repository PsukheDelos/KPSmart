...
package kps.frontend.gui.map.layer.shape.areas;
...
import kps.frontend.gui.map.dataAccess.shape.input.DbfInputStream;
import kps.frontend.gui.map.io.FormatException;
import kps.frontend.gui.map.layer.shape.CSVShapeInfoFile;
import kps.frontend.gui.map.layer.shape.ShapeLayer;
import kps.frontend.gui.map.layer.shape.SpatialIndex;
import kps.frontend.gui.map.omGraphics.DrawingAttributes;
import kps.frontend.gui.map.omGraphics.OMGeometryList;
 ...
 * 
 * 
 *                  layer.class=kps.frontend.gui.map.layer.shape.areas.AreaShapeLayer
...
public class AreaHandler implements PropertyConsumer {
    ...
    public static void printUsage() {
        Debug.output("Usage: java kps.frontend.gui.map.layer.shape.areas.AreaHandler -props <URL to properties file> -prefix <handler property prefix> -file <path to output file>");
        System.exit(-1);
    }

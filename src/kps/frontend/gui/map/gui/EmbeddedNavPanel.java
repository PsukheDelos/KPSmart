...
import kps.frontend.gui.map.SoloMapComponent;
import kps.frontend.gui.map.event.CenterListener;
import kps.frontend.gui.map.event.CenterSupport;
import kps.frontend.gui.map.event.PanListener;
import kps.frontend.gui.map.event.PanSupport;
import kps.frontend.gui.map.event.ProjectionEvent;
import kps.frontend.gui.map.event.ProjectionListener;
import kps.frontend.gui.map.event.ZoomEvent;
import kps.frontend.gui.map.event.ZoomListener;
import kps.frontend.gui.map.event.ZoomSupport;
...
import kps.frontend.gui.map.proj.ProjectionStack;
import kps.frontend.gui.map.proj.ProjectionStackTrigger;
 ...
 * kps.frontend.gui.map.gui.NavigatePanel, kps.frontend.gui.map.gui.ProjectionStackTool,
 * and kps.frontend.gui.map.gui.ZoomPanel.
 * </p>
 */
public class EmbeddedNavPanel extends OMComponentPanel implements
	...
	public static Logger logger = Logger
			.getLogger("kps.frontend.gui.map.gui.EmbeddedNavPanel");
	...
	public Properties getPropertyInfo(Properties props) {
		...
		interString = i18n.get(EmbeddedNavPanel.class,
			PanDistanceProperty,
			kps.frontend.gui.map.I18n.TOOLTIP,
			"Panning Distance.");
		...
		props.put(PanDistanceProperty + ScopedEditorProperty,
			"kps.frontend.gui.map.util.propertyEditor.TextPropertyEditor");

...
/**
* com/bbn/openmap/corba/CSpecialist/ServerPOA.java .
...
public abstract class ServerPOA extends org.omg.PortableServer.Servant
 implements com.bbn.openmap.corba.CSpecialist.ServerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  // unique host:pid:layer context
       ...
       {
         com.bbn.openmap.corba.CSpecialist.CProjection p = com.bbn.openmap.corba.CSpecialist.CProjectionHelper.read (in);
         com.bbn.openmap.corba.CSpecialist.LLPoint ll1 = com.bbn.openmap.corba.CSpecialist.LLPointHelper.read (in);
         com.bbn.openmap.corba.CSpecialist.LLPoint ll2 = com.bbn.openmap.corba.CSpecialist.LLPointHelper.read (in);
         ...
         com.bbn.openmap.corba.CSpecialist.GraphicChange notifyOnChange = com.bbn.openmap.corba.CSpecialist.GraphicChangeHelper.read (in);
         String uniqueID = in.read_string ();
         com.bbn.openmap.corba.CSpecialist.UGraphic $result[] = null;
         $result = this.getRectangle (p, ll1, ll2, staticArgs, dynamicArgs, graphicSeletableDistance, areaEvents, notifyOnChange, uniqueID);
         out = $rh.createReply();
         com.bbn.openmap.corba.CSpecialist.UGraphicSeqHelper.write (out, $result);
  ...
  // longer needed for context host:pid:layer
       ...
       {
         com.bbn.openmap.corba.CSpecialist.WidgetChange notifyOnChange = com.bbn.openmap.corba.CSpecialist.WidgetChangeHelper.read (in);
         String staticArgs = in.read_string ();
         org.omg.CORBA.StringHolder dynamicArgs = new org.omg.CORBA.StringHolder ();
         dynamicArgs.value = in.read_string ();
         String uniqueID = in.read_string ();
         com.bbn.openmap.corba.CSpecialist.UWidget $result[] = null;
         $result = this.getPaletteConfig (notifyOnChange, staticArgs, dynamicArgs, uniqueID);
         out = $rh.createReply();
         com.bbn.openmap.corba.CSpecialist.UWidgetSeqHelper.write (out, $result);
         out.write_string (dynamicArgs.value);
         break;
       }

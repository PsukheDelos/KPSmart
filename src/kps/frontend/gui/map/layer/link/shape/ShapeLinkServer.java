...
package kps.frontend.gui.map.layer.link.shape;
...
import kps.frontend.gui.map.layer.link.LinkBoundingPoly;
import kps.frontend.gui.map.layer.link.LinkGraphicList;
import kps.frontend.gui.map.layer.link.LinkMapRequest;
import kps.frontend.gui.map.layer.link.LinkProperties;
import kps.frontend.gui.map.layer.link.LinkPropertiesConstants;
import kps.frontend.gui.map.layer.link.LinkServer;
import kps.frontend.gui.map.layer.shape.ESRIRecord;
...
public class ShapeLinkServer extends LinkServer implements
    ...
    protected void fetchGraphics(double xmin, double ymin, double xmax,
        ...
        try {
            ...
            return;
        } catch (kps.frontend.gui.map.io.FormatException fe) {

...
// 
// **********************************************************************
package kps.frontend.gui.map.layer;
...
import kps.frontend.gui.map.event.MapMouseEvent;
import kps.frontend.gui.map.omGraphics.EditableOMPoly;
import kps.frontend.gui.map.omGraphics.FontSizer;
import kps.frontend.gui.map.omGraphics.GraphicAttributes;
import kps.frontend.gui.map.omGraphics.OMAction;
import kps.frontend.gui.map.omGraphics.OMArc;
import kps.frontend.gui.map.omGraphics.OMAreaList;
import kps.frontend.gui.map.omGraphics.OMArrowHead;
import kps.frontend.gui.map.omGraphics.OMBitmap;
...
import kps.frontend.gui.map.omGraphics.OMEllipse;
...
import kps.frontend.gui.map.omGraphics.OMScalingIcon;
import kps.frontend.gui.map.omGraphics.OMShape;
import kps.frontend.gui.map.omGraphics.OMSpline;
import kps.frontend.gui.map.omGraphics.OMText;
import kps.frontend.gui.map.omGraphics.OMTextLabeler;
import kps.frontend.gui.map.omGraphics.awt.CircleShapeDecoration;
import kps.frontend.gui.map.omGraphics.awt.LineShapeDecoration;
import kps.frontend.gui.map.omGraphics.awt.ShapeDecorator;
import kps.frontend.gui.map.omGraphics.labeled.LabeledOMSpline;
import kps.frontend.gui.map.omGraphics.meteo.IceAreaShapeDecoration;
import kps.frontend.gui.map.omGraphics.meteo.OMHotSurfaceFront;
import kps.frontend.gui.map.omGraphics.meteo.OMOcclusion;
import kps.frontend.gui.map.omGraphics.util.ArcCalc;
import kps.frontend.gui.map.omGraphics.util.RibbonMaker;
import kps.frontend.gui.map.proj.GreatCircle;
import kps.frontend.gui.map.proj.Length;
import kps.frontend.gui.map.proj.coords.LatLonPoint;
import kps.frontend.gui.map.tools.drawing.DrawingTool;
import kps.frontend.gui.map.tools.drawing.DrawingToolRequestor;
import kps.frontend.gui.map.tools.drawing.OMDrawingTool;
import kps.frontend.gui.map.tools.symbology.milStd2525.SymbolPart;
import kps.frontend.gui.map.tools.symbology.milStd2525.SymbolReferenceLibrary;
import kps.frontend.gui.map.util.Debug;
import kps.frontend.gui.map.util.PaletteHelper;
 ...
 * 
 * @see kps.frontend.gui.map.layer.DemoLayer
 * 
...
public class DemoLayer extends OMGraphicHandlerLayer implements DrawingToolRequestor {
     ...
     */
    protected final kps.frontend.gui.map.tools.drawing.DrawingToolRequestor layer = this;
    /**
    ...
    public DemoLayer() {
        ...
        // received.
        setProjectionChangePolicy(new kps.frontend.gui.map.layer.policy.ListResetPCPolicy(this));
    ...
    public OMGraphicList init() {
        ...
        circle.setRotationAngle(kps.frontend.gui.map.MoreMath.HALF_PI / 2f);
        ...
        sd.addDecoration(new LineShapeDecoration(5, kps.frontend.gui.map.omGraphics.OMColor.clear));
        ...
        sd.addDecoration(new LineShapeDecoration(3, kps.frontend.gui.map.omGraphics.OMColor.clear));
        ...
        omds = new OMDecoratedSpline(llPoints, OMSpline.DECIMAL_DEGREES, OMSpline.LINETYPE_STRAIGHT);
        sd = new ShapeDecorator();
        sd.addDecoration(new LineShapeDecoration(2, kps.frontend.gui.map.omGraphics.OMColor.clear));
        ...
        OMEllipse ell = new OMEllipse(new LatLonPoint.Double(60, -110), 1000, 300, Length.NM, kps.frontend.gui.map.MoreMath.HALF_PI / 2.0);
    ...
    public java.awt.Component getGUI() {
        ...
        // if (dt != null) {
        // OMLine line = (OMLine)
        // getDrawingTool().create("kps.frontend.gui.map.omGraphics.OMLine",
        // layer);
        // if (line != null) {
        // getList().add(line);
        // } else {
        ...
        // getDrawingTool().create("kps.frontend.gui.map.omGraphics.OMCircle",
        // ga, layer);
        // if (circle != null) {
        // getList().add(circle);
        // } else {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                if (dt != null) {
                    ...
                    OMRect rect = (OMRect) getDrawingTool().create("kps.frontend.gui.map.omGraphics.OMRect", fga, layer, false);
                    if (rect != null) {
        ...
        // if (dt != null) {
        // OMRect rect = (OMRect)
        // getDrawingTool().create("kps.frontend.gui.map.omGraphics.OMRect",
        // ga, layer);
        // if (rect != null) {
        // getList().add(rect);
        // } else {
        ...
        // getDrawingTool().create("kps.frontend.gui.map.omGraphics.OMRangeRings",
        // ga, layer);
        // if (rr != null) {
        ...
        // if (dt != null) {
        // OMPoly point = (OMPoly)
        // getDrawingTool().create("kps.frontend.gui.map.omGraphics.OMPoly",
        // ga, layer);
        // if (point != null) {
        // } else {
        // Debug.error("DemoLayer: Drawing tool can't create OMPoly");
        ...
        // getDrawingTool().create("kps.frontend.gui.map.omGraphics.labeled.LabeledOMPoly",
        // ga, layer);

...
import kps.frontend.gui.map.BufferedLayerMapBean;
 ...
 *          controls=kps.frontend.gui.map.gui.LayerControlButtonPanel
...
public class LayersPanel extends OMToolComponent implements Serializable,
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.gui.LayersPanel");

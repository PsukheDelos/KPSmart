...
import kps.frontend.gui.map.gui.AbstractOpenMapMenu;
import kps.frontend.gui.map.proj.Projection;
import kps.frontend.gui.map.proj.ProjectionException;
import kps.frontend.gui.map.proj.ProjectionFactory;
import kps.frontend.gui.map.proj.ProjectionLoader;
...
public class ProjectionMenu extends AbstractOpenMapMenu implements
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.gui.menu.ProjectionMenu");

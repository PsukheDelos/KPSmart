...
package kps.frontend.gui.map.plugin.esri;
...
import kps.frontend.gui.map.dataAccess.shape.DrawingAttributesUtility;
import kps.frontend.gui.map.dataAccess.shape.EsriGraphicList;
import kps.frontend.gui.map.dataAccess.shape.EsriPointList;
import kps.frontend.gui.map.dataAccess.shape.EsriPolygonList;
import kps.frontend.gui.map.dataAccess.shape.EsriPolylineList;
...
import kps.frontend.gui.map.plugin.BeanContextAbstractPlugIn;
...
import kps.frontend.gui.map.util.DataBoundsProvider;
 ...
 *    
 *    
 *       esri.class = kps.frontend.gui.map.plugin.esri.EsriPlugIn
...
public class EsriPlugIn extends BeanContextAbstractPlugIn implements
    ...
    public Properties getPropertyInfo(Properties props) {
        ...
        props.put(PARAM_SHP + ScopedEditorProperty,
                "kps.frontend.gui.map.util.propertyEditor.FDUPropertyEditor");

...
package kps.frontend.gui.map.layer.location;
...
import kps.frontend.gui.map.layer.DeclutterMatrix;
 ...
 *   locationlayer.declutterMatrix=kps.frontend.gui.map.layer.DeclutterMatrix
...
public class LocationLayer
   ...
   public Properties getPropertyInfo(Properties list) {
      ...
      PropUtils.setI18NPropertyInfo(i18n, list, LocationLayer.class, DeclutterMatrixClassProperty, "Declutter Matrix Class",
                                    "Class name of the declutter matrix to use (kps.frontend.gui.map.layer.DeclutterMatrix).", null);

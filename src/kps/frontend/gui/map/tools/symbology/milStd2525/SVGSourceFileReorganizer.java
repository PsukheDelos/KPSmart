 ...
 * <pre>
 * 
 *  Usage: java kps.frontend.gui.map.tools.symbology.milStd2525.SVGSourceFileReorganizer -target targetDir -source (dir path 1)(dir path 2) ...
 * 
 * </pre>
 */
public class SVGSourceFileReorganizer
     ...
     * 
     * @see
     * kps.frontend.gui.map.util.wanderer.WandererCallback#handleDirectory(java.io
     * .File)
     */

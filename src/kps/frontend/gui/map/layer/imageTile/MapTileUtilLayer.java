...
import kps.frontend.gui.map.layer.policy.ListResetPCPolicy;
...
import kps.frontend.gui.map.proj.coords.MercatorUVGCT;
import kps.frontend.gui.map.util.DataBounds;
import kps.frontend.gui.map.util.propertyEditor.DirectoryPropertyEditor;
...
public class MapTileUtilLayer
   ...
   protected static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.imageTile.MapTileUtilLayer");

...
import kps.frontend.gui.map.event.CenterEvent;
...
import kps.frontend.gui.map.event.PaintListenerSupport;
import kps.frontend.gui.map.event.PanEvent;
import kps.frontend.gui.map.event.PanListener;
import kps.frontend.gui.map.event.ProjectionChangeVetoException;
import kps.frontend.gui.map.event.ProjectionEvent;
import kps.frontend.gui.map.event.ProjectionListener;
import kps.frontend.gui.map.event.ProjectionSupport;
...
public class MapBean
   ...
   public static Logger logger = Logger.getLogger("kps.frontend.gui.map.MapBean");
    ...
    * 
    * @param e ContainerEvent
    * @see kps.frontend.gui.map.MapBean#purgeAndNotifyRemovedLayers
    */

...
package kps.frontend.gui.map.dataAccess.dted;
...
import kps.frontend.gui.map.omGraphics.grid.OMGridGenerator;
import kps.frontend.gui.map.omGraphics.grid.SinkGenerator;
 ...
 *    markerName.greys.class=kps.frontend.gui.map.omGraphics.grid.SlopeGeneratorLoader
 *    markerName.greys.prettyName=Slope Shading
 *    markerName.greys.colorsClass=kps.frontend.gui.map.omGraphics.grid.GreyscaleSlopeColors
 *    markerName.colors.class=kps.frontend.gui.map.omGraphics.grid.SlopeGeneratorLoader
 *    markerName.colors.prettyName=Elevation Shading
 *    markerName.colors.colorsClass=kps.frontend.gui.map.omGraphics.grid.ColoredShadingColors
 * 
 * 
 * </pre>
 * 

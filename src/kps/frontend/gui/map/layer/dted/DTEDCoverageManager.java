...
import kps.frontend.gui.map.util.wanderer.Wanderer;
import kps.frontend.gui.map.util.wanderer.WandererCallback;
...
public class DTEDCoverageManager
   ...
   public static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.dted.DTEDCoverageManager");

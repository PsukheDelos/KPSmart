...
import kps.frontend.gui.map.dataAccess.shape.input.LittleEndianInputStream;
...
public class EsriGraphicFactory implements ShapeConstants {
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.dataAccess.shape.EsriGraphicFactory");

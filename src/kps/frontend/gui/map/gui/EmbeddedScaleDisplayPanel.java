...
public class EmbeddedScaleDisplayPanel
   ...
   public static Logger logger = Logger.getLogger("kps.frontend.gui.map.gui.EmbedddedScaleDisplayPanel");
   ...
   public void setProperties(String prefix, Properties properties) {
      ...
      prefix = kps.frontend.gui.map.util.PropUtils.getScopedPropertyPrefix(prefix);
   ...
   public void setUnitOfMeasure(String unitOfMeasure) {
      ...
      // This does not work:
      // uom = kps.frontend.gui.map.proj.Length.get(unitOfMeasure);

...
package kps.frontend.gui.map.gui;
...
import kps.frontend.gui.map.BufferedMapBean;
...
import kps.frontend.gui.map.event.DefaultOverviewMouseMode;
 ...
 *       overviewMapHandler.overviewStatusLayer.class=kps.frontend.gui.map.layer.OverviewMapAreaLayer
 ...
 *       overviewLayer.class=kps.frontend.gui.map.layer.shape.ShapeLayer
...
public class OverviewMapHandler extends OMToolComponent implements ProjectionListener,
    ...
    public Properties getPropertyInfo(Properties list) {
        ...
        list.put(StatusLayerProperty, "Class name of layer to use as the active layer on the overview map, receiving mouse events (Default is kps.frontend.gui.map.layer.OverviewMapAreaLayer).");
        ...
        list.put(ControlSourceMapProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.TrueFalsePropertyEditor");
        ...
        list.put(BackgroundSlaveProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.TrueFalsePropertyEditor");
    ...
    public void findAndInit(Object someObj) {
        if (someObj instanceof kps.frontend.gui.map.MapBean) {

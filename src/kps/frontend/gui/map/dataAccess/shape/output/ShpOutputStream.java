...
package kps.frontend.gui.map.dataAccess.shape.output;
...
public class ShpOutputStream {
   ...
   public static Logger logger = Logger.getLogger("kps.frontend.gui.map.dataAccess.shape.output.ShpOutputStream");

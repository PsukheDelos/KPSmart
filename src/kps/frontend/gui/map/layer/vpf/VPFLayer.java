 ...
 * {@link kps.frontend.gui.map.layer.vpf.DescribeDB DescribeDB}is a utility to help
 ...
 *     vmapPol.class= kps.frontend.gui.map.layer.vpf.VPFLayer
 ...
 *     # See {@link kps.frontend.gui.map.layer.vpf.LibraryBean LibraryBean javadoc} for properties info. (Example below)
 *     vmapPol.libraryBean= VMAPdata
 *     VMAPData.class=kps.frontend.gui.map.layer.vpf.LibraryBean
 ...
 *     vmapCoast.class=kps.frontend.gui.map.layer.vpf.VPFLayer
 ...
 *     dcwPolitical.class=kps.frontend.gui.map.layer.vpf.VPFLayer
...
public class VPFLayer
   ...
   public static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.vpf.VPFLayer");
   ...
   protected void initLST() {
      ...
      } catch (kps.frontend.gui.map.io.FormatException f) {

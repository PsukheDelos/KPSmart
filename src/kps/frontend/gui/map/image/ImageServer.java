...
package kps.frontend.gui.map.image;
...
public class ImageServer
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.image.ImageServer");
     ...
     * 
     * @param newLayers an array of kps.frontend.gui.map.Layer objects, already
     ...
     * 
     * <pre>
     * java kps.frontend.gui.map.image.ImageServer -properties (path to properties file) -file (path to output image)
     * </pre>
     * 
     * <P>
    ...
    public static void main(String[] argv) {
        ...
        kps.frontend.gui.map.util.ArgParser ap = new kps.frontend.gui.map.util.ArgParser("ImageServer");

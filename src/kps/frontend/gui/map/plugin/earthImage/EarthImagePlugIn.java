...
package kps.frontend.gui.map.plugin.earthImage;
...
import kps.frontend.gui.map.image.ImageServerConstants;
import kps.frontend.gui.map.omGraphics.OMGraphicList;
import kps.frontend.gui.map.omGraphics.OMRaster;
import kps.frontend.gui.map.plugin.AbstractPlugIn;
 ...
 * 
 * #For the plugin layer pluginlayer.class=kps.frontend.gui.map.plugin.PlugInLayer
 * pluginlayer.prettyName=Whatever
 * pluginlayer.plugin=kps.frontend.gui.map.plugin.earthImage.EarthImagePlugIn
...
public class EarthImagePlugIn
   ...
   public Properties getPropertyInfo(Properties props) {
      ...
      props.put(ImageProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.FUPropertyEditor");

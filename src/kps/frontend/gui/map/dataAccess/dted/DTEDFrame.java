...
import kps.frontend.gui.map.io.Closable;
...
import kps.frontend.gui.map.omGraphics.grid.OMGridData;
import kps.frontend.gui.map.omGraphics.grid.SlopeGenerator;
...
public class DTEDFrame
    ...
    public static void main(String args[]) {
        ...
        final kps.frontend.gui.map.omGraphics.OMGraphic ras = df.getImage(crg);

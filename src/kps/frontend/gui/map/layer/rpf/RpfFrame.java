...
import kps.frontend.gui.map.layer.nitf.NitfHeader;
...
//      }
   ...
   public static void main(String[] argv) {
      ...
      kps.frontend.gui.map.util.ArgParser ap = new kps.frontend.gui.map.util.ArgParser("RpfFrame");
   ...
   public void view() {
      ...
      JFrame frame = kps.frontend.gui.map.util.PaletteHelper.getPaletteWindow(picture, "RPF Frame", null);

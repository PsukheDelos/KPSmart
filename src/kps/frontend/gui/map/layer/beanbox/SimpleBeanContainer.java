...
import kps.frontend.gui.map.tools.beanbox.BeanLayoutManager;

/**
 * A SimpleBeanContainer is itself a bean. Hence this class extends
 * the {@link kps.frontend.gui.map.layer.beanbox.SimpleBeanObject}.
 * SimpleBeanContainer is a sample implementation of the
 * {@link kps.frontend.gui.map.tools.beanbox.BeanContainer}interface.
 */
public class SimpleBeanContainer extends SimpleBeanObject implements
    ...
    public SimpleBeanContainer(long id, float centerLatitude,
        ...
        super.setCustomGraphicClassName("kps.frontend.gui.map.layer.beanbox.ContainerGraphic");

...
package kps.frontend.gui.map.util.propertyEditor;
 ...
 * shapeFile.editor=kps.frontend.gui.map.util.propertyEditor.FilePropertyEditor
 * </code>.
 */
public class Inspector implements ActionListener {

    /** A simple TextField as a String editor. */
    protected final String defaultEditorClass = "kps.frontend.gui.map.util.propertyEditor.TextPropertyEditor";
    ...
    public static void main(String[] args) {
        Debug.init();
        String name = (args.length < 1) ? "kps.frontend.gui.map.layer.shape.ShapeLayer"
                : args[0];

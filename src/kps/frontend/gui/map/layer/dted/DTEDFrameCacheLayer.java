...
package kps.frontend.gui.map.layer.dted;
...
import kps.frontend.gui.map.dataAccess.dted.DTEDConstants;
import kps.frontend.gui.map.dataAccess.dted.DTEDDirectoryHandler;
import kps.frontend.gui.map.dataAccess.dted.DTEDFrameCacheHandler;
import kps.frontend.gui.map.dataAccess.dted.DTEDNameTranslator;
...
import kps.frontend.gui.map.omGraphics.grid.GeneratorLoader;
import kps.frontend.gui.map.omGraphics.grid.SlopeGeneratorLoader;
import kps.frontend.gui.map.proj.EqualArc;
 ...
 * use the kps.frontend.gui.map.layer.rpf.ChangeCase class to make modifications if
 * necessary.
 * <P>
 * 
 * <pre>
 ...
 *    dted.greys.class=kps.frontend.gui.map.omGraphics.grid.SlopeGeneratorLoader
 *    dted.greys.prettyName=Slope Shading
 *    dted.greys.colorsClass=kps.frontend.gui.map.omGraphics.grid.GreyscaleSlopeColors
 *    dted.colors.class=kps.frontend.gui.map.omGraphics.grid.SlopeGeneratorLoader
 *    dted.colors.prettyName=Elevation Shading
 *    dted.colors.colorsClass=kps.frontend.gui.map.omGraphics.grid.ColoredShadingColors
 *   
 *    #-------------------------------------
 ...
 * </pre>
 * 
 * @see kps.frontend.gui.map.layer.rpf.ChangeCase
 */
public class DTEDFrameCacheLayer extends OMGraphicHandlerLayer implements ActionListener,
     ...
     */
    public DTEDFrameCacheLayer(kps.frontend.gui.map.dataAccess.dted.DTEDFrameCache dfc) {
        this();
        setFrameCache(dfc);
    }

    public void setFrameCache(kps.frontend.gui.map.dataAccess.dted.DTEDFrameCache dfc) {
        cache.setFrameCache(dfc);
        cache.resetCache();
    }

    public kps.frontend.gui.map.dataAccess.dted.DTEDFrameCache getFrameCache() {
        if (cache != null) {
    ...
    public void findAndInit(Object someObj) {
        if (someObj instanceof kps.frontend.gui.map.dataAccess.dted.DTEDFrameCache) {
            setFrameCache((kps.frontend.gui.map.dataAccess.dted.DTEDFrameCache) someObj);
        }
    }
    ...
    public static class Builder {
        ...
        public DTEDFrameCacheLayer create() {
            kps.frontend.gui.map.dataAccess.dted.DTEDFrameCache dfc = new kps.frontend.gui.map.dataAccess.dted.DTEDFrameCache();
            ...
            kps.frontend.gui.map.dataAccess.dted.DTEDFrameCacheHandler dfcHandler = layer.getCache();

...
public class MapWindow extends JFrame {
    ...
    public static void main(String[] argv) {
        ...
        try {
            mw.addTo(new kps.frontend.gui.map.layer.shape.ShapeLayer("share/data/shape/dcwpo-browse.shp"));
            mw.addTo(new kps.frontend.gui.map.event.NavMouseMode2());
            mw.addTo(new kps.frontend.gui.map.gui.ToolPanel());
            mw.addTo(new kps.frontend.gui.map.gui.OMToolSet());

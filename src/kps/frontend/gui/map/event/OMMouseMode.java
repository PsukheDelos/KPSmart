...
import kps.frontend.gui.map.image.ImageScaler;
...
public class OMMouseMode extends CoordMouseMode {
    ...
    public Properties getPropertyInfo(Properties props) {
        ...
        PropUtils.setI18NPropertyInfo(i18n, props, OMMouseMode.class, LEAVE_SHADOW_PROPERTY, "Leave Shadow", "Display current map in background while panning.", "kps.frontend.gui.map.util.propertyEditor.YesNoPropertyEditor");
        PropUtils.setI18NPropertyInfo(i18n, props, OMMouseMode.class, USE_CURSOR_PROPERTY, "Use Cursor", "Use hand cursor for mouse mode.", "kps.frontend.gui.map.util.propertyEditor.YesNoPropertyEditor");
        PropUtils.setI18NPropertyInfo(i18n, props, OMMouseMode.class, AZ_PANNING_SHAPEFILE_PROPERTY, "Az Projection Panning Shapefile", "Use a shapefile for azimuthal projection panning.", "kps.frontend.gui.map.util.propertyEditor.FUPropertyEditor");

...
import kps.frontend.gui.map.proj.LineType;
...
public interface OMGraphicConstants {
     ...
     * switching over to kps.frontend.gui.map.proj.Length.
     */
    public final static int DECIMAL_DEGREES = 0;
    /**
     * The float coordinates are in radians. Should not be used - switching over
     * to kps.frontend.gui.map.proj.Length.
     */
    public final static int RADIANS = 1;

    /** A transparent color. */
    public final static Color clear = kps.frontend.gui.map.util.ColorFactory.createColor(0,
                                                                                    true);

...
import kps.frontend.gui.map.omGraphics.OMList;
...
public class RpfLayer
    ...
    protected static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.rpf.RpfLayer");
    ...
    public Properties getPropertyInfo(Properties list) {
        ...
        list.put(RpfPathsProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.MultiDirectoryPropertyEditor");
        ...
        list.put(KillCacheProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.OnOffPropertyEditor");
...
//    }
    ...
    public static void main(String[] argv) {
        ...
        System.out.println("layer.class=kps.frontend.gui.map.layer.rpf.RpfLayer");

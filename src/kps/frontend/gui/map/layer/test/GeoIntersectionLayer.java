...
import kps.frontend.gui.map.dataAccess.shape.DbfTableModel;
import kps.frontend.gui.map.dataAccess.shape.EsriGraphicList;
import kps.frontend.gui.map.event.MapMouseEvent;
import kps.frontend.gui.map.geo.BoundaryCrossing;
import kps.frontend.gui.map.geo.BoundingCircle;
import kps.frontend.gui.map.geo.ExtentIndex;
import kps.frontend.gui.map.geo.ExtentIndexImpl;
import kps.frontend.gui.map.geo.Geo;
import kps.frontend.gui.map.geo.GeoPath;
import kps.frontend.gui.map.geo.GeoPoint;
import kps.frontend.gui.map.geo.GeoRegion;
import kps.frontend.gui.map.geo.GeoSegment;
import kps.frontend.gui.map.geo.Intersection;
import kps.frontend.gui.map.layer.editor.EditorLayer;
...
import kps.frontend.gui.map.util.ArgParser;
import kps.frontend.gui.map.util.Debug;
import kps.frontend.gui.map.util.FileUtils;
import kps.frontend.gui.map.util.PaletteHelper;
import kps.frontend.gui.map.util.PropUtils;

/**
 * This layer demonstrates the use of the kps.frontend.gui.map.geo package to do
 ...
 * 
 * <pre>
 *        geo.class=kps.frontend.gui.map.layer.test.GeoIntersectionLayer
 *        geo.prettyName=GEO Intersections
 *        geo.editor=kps.frontend.gui.map.layer.editor.DrawingEditorTool
 *        geo.showAttributes=true
 *        geo.loaders=lines polys points
 *        geo.mouseModes=Gestures
 *        geo.lines.class=kps.frontend.gui.map.tools.drawing.OMLineLoader
 *        geo.polys.class=kps.frontend.gui.map.tools.drawing.OMPolyLoader
 *        geo.points.class=kps.frontend.gui.map.tools.drawing.OMPointLoader
...
public class GeoIntersectionLayer extends EditorLayer implements PropertyChangeListener {
    ...
    public static class OMLineSegment implements GeoSegment {
         ...
         * (non-Javadoc)
         * 
         * @see kps.frontend.gui.map.geo.GeoSegment#getSeg()
         */
        public Geo[] getSeg() {
            return geos;
        }
         ...
         * (non-Javadoc)
         * 
         * @see kps.frontend.gui.map.geo.GeoSegment#getSegArray()
         */
         ...
         * (non-Javadoc)
         * 
         * @see kps.frontend.gui.map.geo.GeoExtent#getID()
         */
        public Object getID() {
            return this;
        }

...
public class LabeledOMPoly
     ...
     * 
     * @see kps.frontend.gui.map.omGraphics.OMPoly#OMPoly(int[])
     */
     ...
     * 
     * @see kps.frontend.gui.map.omGraphics.OMText#JUSTIFY_LEFT
     * @see kps.frontend.gui.map.omGraphics.OMText#JUSTIFY_CENTER
     * @see kps.frontend.gui.map.omGraphics.OMText#JUSTIFY_RIGHT
     */

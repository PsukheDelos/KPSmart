 ...
 *        #######################################
 *        scaledFilterLayer.class=kps.frontend.gui.map.layer.ScaleFilterLayer
...
public class ScaleFilterLayer
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.ScaleFilterLayer");
     ...
     * @see kps.frontend.gui.map.event.NavMouseMode#modeID
     * @see kps.frontend.gui.map.event.SelectMouseMode#modeID
     * @see kps.frontend.gui.map.event.NullMouseMode#modeID
     */

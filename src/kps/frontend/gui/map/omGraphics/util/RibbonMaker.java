...
import kps.frontend.gui.map.geo.Ribbon;
import kps.frontend.gui.map.geo.RibbonIterator;
...
public class RibbonMaker {
    ...
    private static final Logger logger = Logger.getLogger("kps.frontend.gui.map.omGraphics.util.RibbonMaker");

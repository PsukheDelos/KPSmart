...
import kps.frontend.gui.map.image.AbstractImageFormatter;
...
public class SaveAsMenu extends AbstractOpenMapMenu {
    ...
    public void addSVGMenuItem(JMenu menu) {
        try {
            Object obj = kps.frontend.gui.map.util.ComponentFactory.create("kps.frontend.gui.map.image.SVGFormatter");

...
package kps.frontend.gui.map.layer.editor;
...
import kps.frontend.gui.map.InformationDelegator;
...
import kps.frontend.gui.map.gui.GridBagToolBar;
import kps.frontend.gui.map.gui.OMGraphicDeleteTool;
import kps.frontend.gui.map.layer.DrawingToolLayer;
...
import kps.frontend.gui.map.tools.drawing.EditToolLoader;
import kps.frontend.gui.map.tools.drawing.OMCircleLoader;
import kps.frontend.gui.map.tools.drawing.OMDistanceLoader;
import kps.frontend.gui.map.tools.drawing.OMDrawingTool;
import kps.frontend.gui.map.tools.drawing.OMDrawingToolMouseMode;
import kps.frontend.gui.map.tools.drawing.OMLineLoader;
import kps.frontend.gui.map.tools.drawing.OMPointLoader;
import kps.frontend.gui.map.tools.drawing.OMPolyLoader;
 ...
 *   dtlayer.class=kps.frontend.gui.map.layer.editor.EditorLayer
 ...
 *   dtlayer.editor=kps.frontend.gui.map.layer.editor.DrawingEditorTool
 ...
 *   dtlayer.polys.class=kps.frontend.gui.map.tools.drawing.OMPolyLoader
 *   # Set the DrawingAttributes class to use for polys
 *   dtlayer.polys.attributesClass=kps.frontend.gui.map.omGraphics.DrawingAttributes
 ...
 *   dtlayer.points.class=kps.frontend.gui.map.tools.drawing.OMPointLoader
 * dtlayer.lines.class=kps.frontend.gui.map.tools.drawing.OMLineLoader
 * 
 */
public class DrawingEditorTool extends AbstractEditorTool implements ActionListener,
    ...
    public final static String DefaultDrawingAttributesClass = "kps.frontend.gui.map.omGraphics.DrawingAttributes";

...
import kps.frontend.gui.map.dataAccess.shape.input.ShpInputStream;
import kps.frontend.gui.map.dataAccess.shape.input.ShxInputStream;
...
public abstract class EsriGraphicList
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.dataAccess.shape.EsriGraphicList");

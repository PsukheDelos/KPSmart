...
import kps.frontend.gui.map.omGraphics.BasicStrokeEditor;
...
import kps.frontend.gui.map.util.ColorFactory;
...
public class EsriShapeExport implements ShapeConstants, OMGraphicConstants {
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.dataAccess.shape.EsriShapeExport");
     ...
     * the user cancels.
     * 
     * @see kps.frontend.gui.map.util.FileUtils#getFilePathToSaveFromUser(String)
     */

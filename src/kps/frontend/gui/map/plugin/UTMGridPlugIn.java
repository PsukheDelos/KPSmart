...
package kps.frontend.gui.map.plugin;
...
import kps.frontend.gui.map.omGraphics.OMColorChooser;
import kps.frontend.gui.map.omGraphics.OMGeometry;
...
import kps.frontend.gui.map.omGraphics.geom.BasicGeometry;
import kps.frontend.gui.map.omGraphics.geom.PolygonGeometry;
import kps.frontend.gui.map.omGraphics.geom.PolylineGeometry;
...
import kps.frontend.gui.map.proj.coords.UTMPoint;

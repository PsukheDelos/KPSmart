...
package kps.frontend.gui.map.graphicLoader;
...
import kps.frontend.gui.map.dataAccess.dted.DTEDFrameCache;
...
import kps.frontend.gui.map.proj.DrawUtil;
...
import kps.frontend.gui.map.tools.terrain.LOSGenerator;
...
public class LOSGraphicLoader extends MMLGraphicLoader implements
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.graphicLoader.LOSGraphicLoader");
    ...
    public void actionPerformed(java.awt.event.ActionEvent ae) {
        ...
        if (cmd == TimerCmd) {
            ...
            if (dt != null) {
                ...
                OMPoint pt = (OMPoint) dt.create("kps.frontend.gui.map.omGraphics.OMPoint",
                        ga,
                        this,
                        false);
                if (pt != null) {
            ...
            if (dt != null) {
                ...
                OMPoly poly = (OMPoly) dt.create("kps.frontend.gui.map.omGraphics.OMPoly",
                        ga,
                        this,
                        true);
                if (poly != null) {

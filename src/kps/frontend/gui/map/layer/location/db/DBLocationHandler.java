...
package kps.frontend.gui.map.layer.location.db;
...
import kps.frontend.gui.map.layer.location.ByteRasterLocation;
 ...
 *  
 *  dblocationhandler.class=kps.frontend.gui.map.layer.location.db.DBLocationHandler

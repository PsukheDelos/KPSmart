 ...
 * zoomMarker.class=kps.frontend.gui.map.image.ZoomLevelInfo
...
public class ZoomLevelMaker extends ZoomLevelInfo {
    ...
    public Properties getPropertyInfo(Properties props) {
        ...
        PropUtils.setI18NPropertyInfo(i18n, props, kps.frontend.gui.map.dataAccess.mapTile.ZoomLevelMaker.class, NAME_PROPERTY, "Name", "Name for zoom level tiles", null);

        PropUtils.setI18NPropertyInfo(i18n, props, kps.frontend.gui.map.dataAccess.mapTile.ZoomLevelMaker.class, DESCRIPTION_PROPERTY, "Descroption", "Description for zoom level tiles", null);

        PropUtils.setI18NPropertyInfo(i18n, props, kps.frontend.gui.map.dataAccess.mapTile.ZoomLevelMaker.class, ZOOM_LEVEL_PROPERTY, "Zoom Level (1-20)", "Number for zoom level", null);

        PropUtils.setI18NPropertyInfo(i18n, props, kps.frontend.gui.map.dataAccess.mapTile.ZoomLevelMaker.class, BOUNDS_PROPERTY, "Bounds", "Bounds for tile creation (lat lon lat lon)", null);

        PropUtils.setI18NPropertyInfo(i18n, props, kps.frontend.gui.map.dataAccess.mapTile.ZoomLevelMaker.class, LAYERS_PROPERTY, "Layers", "Space separated marker names for layers used in tiles.", null);

        PropUtils.setI18NPropertyInfo(i18n, props, kps.frontend.gui.map.dataAccess.mapTile.ZoomLevelMaker.class, RANGE_PROPERTY, "Range", "Zoom level to create tiles down to, using the tiles created at this zoom level.", null);

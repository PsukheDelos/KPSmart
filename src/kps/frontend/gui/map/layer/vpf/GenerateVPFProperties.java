 ...
 * 
 *  Usage:
 *  java kps.frontend.gui.map.layer.vpf.GenerateVPFproperties /path/to/vpf/database
 * 
 * </pre>
 * 
...
public class GenerateVPFProperties
   ...
   public static void main(String[] args)
      ...
      if (args.length == 0) {
         Debug.output("Usage: java kps.frontend.gui.map.layer.vpf.GenerateVPFProperties <path to vpf database directory> <path to vpf database directory> ...");
         System.exit(0);
      }
   ...
   public static String printCoverageProperties(String prefix, CoverageAttributeTable cat, String covname) {
      ...
      if (!(text_features.isEmpty() && edge_features.isEmpty() && area_features.isEmpty() && point_features.isEmpty())) {
         ...
         println(layername + ".class=kps.frontend.gui.map.layer.vpf.VPFLayer");

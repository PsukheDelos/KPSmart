...
package kps.frontend.gui.map.tools.beanbox;
...
import kps.frontend.gui.map.tools.dnd.ComponentDragGestureListener;
import kps.frontend.gui.map.tools.dnd.DefaultDnDCatcher;
import kps.frontend.gui.map.tools.dnd.DefaultTransferableObject;
 ...
 * {@link kps.frontend.gui.map.tools.beanbox.BeanBoxHandler}interface.
 */
public class BeanBoxDnDCatcher extends DefaultDnDCatcher implements
    ...
    /**
     * holds the {@link kps.frontend.gui.map.tools.beanbox.BeanBox}that manages the
    ...
    /**
     * Constructs a new {@link kps.frontend.gui.map.tools.dnd.DnDListener} object.
     */
    ...
    /**
     * Displays a {@link kps.frontend.gui.map.tools.beanbox.GenericPropertySheet}if

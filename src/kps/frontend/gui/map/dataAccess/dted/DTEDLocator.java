 ...
 * <pre>
 * 
 *  Usage: java kps.frontend.gui.map.dataAccess.dted.DTEDLocator (dir path) ...
 * 
 * </pre>
 */
public class DTEDLocator
   ...
   static Logger logger = Logger.getLogger("kps.frontend.gui.map.dataAccess.dted.DTEDLocator");

...
package kps.frontend.gui.map.plugin.wms;
...
import kps.frontend.gui.map.image.WMTConstants;
import kps.frontend.gui.map.plugin.WebImagePlugIn;
 ...
 *     wms_plugin=kps.frontend.gui.map.plugin.wms.WMSPlugIn
...
public class WMSPlugIn extends WebImagePlugIn implements ImageServerConstants {
    ...
    public Properties getPropertyInfo(Properties props) {
        ...
        props.put(TransparentProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.YesNoPropertyEditor");
        props.put(BackgroundColorProperty, "The Background color for the image");
        props.put(BackgroundColorProperty + ScopedEditorProperty, "kps.frontend.gui.map.util.propertyEditor.ColorPropertyEditor");

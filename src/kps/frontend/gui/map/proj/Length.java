...
public class Length implements Serializable {
    ...
    public final static Length RADIAN = new Length("radian", "rad", kps.frontend.gui.map.MoreMath.TWO_PI_D) {
    ...
    public Length(String name, String abbr, double unitEquatorCircumference) {
        ...
        this.constant = unitEquatorCircumference / kps.frontend.gui.map.MoreMath.TWO_PI_D;

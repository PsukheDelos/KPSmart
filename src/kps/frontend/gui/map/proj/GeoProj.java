 ...
 * @see Planet
 * @see GreatCircle
 * @see kps.frontend.gui.map.omGraphics.OMPoly
 * 
 */
public abstract class GeoProj
    ...
    public float getScale(Point2D ll1, Point2D ll2, Point2D point1, Point2D point2) {
        ...
        try {
            ...
            kps.frontend.gui.map.util.Debug.error("ProjMath.getScale(): caught null pointer exception.");
     ...
     * href="kps.frontend.gui.map.proj.ProjMath.html#arrayDegToRad">

...
import kps.frontend.gui.map.dataAccess.shape.EsriPolyline;
import kps.frontend.gui.map.dataAccess.shape.EsriPolylineList;
import kps.frontend.gui.map.dataAccess.shape.output.DbfOutputStream;
import kps.frontend.gui.map.dataAccess.shape.output.ShpOutputStream;
import kps.frontend.gui.map.dataAccess.shape.output.ShxOutputStream;
import kps.frontend.gui.map.event.NavMouseMode;
import kps.frontend.gui.map.event.SelectMouseMode;
import kps.frontend.gui.map.gui.DefaultHelpMenu;
import kps.frontend.gui.map.gui.LayersMenu;
import kps.frontend.gui.map.gui.MouseModePanel;
import kps.frontend.gui.map.gui.OMToolSet;
import kps.frontend.gui.map.gui.Tool;
...
public class ExampleApplication extends JFrame {
    ...
    public static void main(String args[]) {
        kps.frontend.gui.map.util.Debug.init();

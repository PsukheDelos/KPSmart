...
package kps.frontend.gui.map.layer.link.amp;
...
import kps.frontend.gui.map.layer.link.ClientLink;
import kps.frontend.gui.map.layer.link.Link;
import kps.frontend.gui.map.layer.link.LinkActionList;
import kps.frontend.gui.map.layer.link.LinkGraphic;
import kps.frontend.gui.map.layer.link.LinkLayer;
import kps.frontend.gui.map.layer.link.LinkOMGraphicList;
import kps.frontend.gui.map.layer.link.LinkProperties;
        ...
        if (gui == null) {
            ...
            rrButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    ...
                    if (dt != null) {
                        OMRangeRings rr = (OMRangeRings) getDrawingTool().create("kps.frontend.gui.map.omGraphics.OMRangeRings",
                                ga,
                                layer);
                        if (rr != null) {
            ...
            eZone.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    ...
                    if (dt != null) {
                        OMCircle circle = (OMCircle) getDrawingTool().create("kps.frontend.gui.map.omGraphics.OMCircle",
                                ga,
                                layer);
                        if (circle == null) {

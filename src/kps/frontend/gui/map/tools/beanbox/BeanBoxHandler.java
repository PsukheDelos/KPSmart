 ...
 * {@link kps.frontend.gui.map.tools.beanbox.BeanBoxDnDCatcher}via the
 * {@link kps.frontend.gui.map.tools.beanbox.BeanBox}instance associated
 * with the layer. The BeanBoxDnDCatcher class uses the getBeanBox()
 * method declared on this interface to obtain access to the
 * {@link kps.frontend.gui.map.tools.beanbox.BeanBox}object associated
 * with the layer.
 */
public interface BeanBoxHandler {
     ...
     * {@link kps.frontend.gui.map.tools.beanbox.BeanBox}class instance.
     */

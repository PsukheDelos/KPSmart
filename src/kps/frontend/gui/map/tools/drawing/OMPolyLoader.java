...
import kps.frontend.gui.map.omGraphics.labeled.EditableLabeledOMPoly;
...
public class OMPolyLoader extends AbstractToolLoader implements EditToolLoader {
    ...
    protected String graphicClassName = "kps.frontend.gui.map.omGraphics.OMPoly";
    protected String labeledClassName = "kps.frontend.gui.map.omGraphics.labeled.LabeledOMPoly";
    ...
    public void init() {
        EditClassWrapper ecw = new EditClassWrapper(graphicClassName, "kps.frontend.gui.map.omGraphics.EditableOMPoly", "editablepoly.gif", i18n.get(OMPolyLoader.class,
                "ompoly",
                "Polygons/Polylines"));

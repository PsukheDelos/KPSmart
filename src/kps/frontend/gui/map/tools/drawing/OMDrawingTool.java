...
import kps.frontend.gui.map.event.UndoStack;
import kps.frontend.gui.map.gui.OMToolComponent;
import kps.frontend.gui.map.gui.WindowSupport;
import kps.frontend.gui.map.gui.menu.UndoMenuItemStackTrigger;
import kps.frontend.gui.map.omGraphics.DrawingAttributes;
import kps.frontend.gui.map.omGraphics.EditableOMGraphic;
import kps.frontend.gui.map.omGraphics.EditableOMGraphicList;
...
import kps.frontend.gui.map.omGraphics.editable.GraphicSelectedState;
import kps.frontend.gui.map.omGraphics.event.EOMGEvent;
import kps.frontend.gui.map.omGraphics.event.EOMGListener;
import kps.frontend.gui.map.omGraphics.event.SelectionListener;
import kps.frontend.gui.map.omGraphics.event.SelectionProvider;
import kps.frontend.gui.map.omGraphics.event.SelectionSupport;
 ...
 * <P>
 * 
 * The OMDrawingTool is also a kps.frontend.gui.map.gui.Tool, which allows it to
...
public class OMDrawingTool extends OMToolComponent implements DrawingTool, Serializable,
     ...
     * OMDrawingTool is a kps.frontend.gui.map.gui.Tool object, it will only appear
     ...
     * @see kps.frontend.gui.map.omGraphics.OMGraphicConstants
     */
    public synchronized void deactivate(int actionToDoWithOMGraphic) {
        ...
        if (currentEditable != null) {
            if (!(currentEditable.getStateMachine().getState() instanceof kps.frontend.gui.map.omGraphics.editable.GraphicUndefinedState)) {

...
package kps.frontend.gui.map.layer.shape;
...
import kps.frontend.gui.map.dataAccess.shape.DbfHandler;
import kps.frontend.gui.map.dataAccess.shape.EsriGraphicFactory;
import kps.frontend.gui.map.dataAccess.shape.ShapeUtils;
import kps.frontend.gui.map.io.BinaryBufferedFile;
import kps.frontend.gui.map.io.BinaryFile;
 ...
 * 
 * <H2>Usage</H2>
 * <DT>java kps.frontend.gui.map.layer.shape.SpatialIndex -d file.ssx</DT>
 * <DD><i>Dumps spatial index information, excluding bounding boxes to stdout.
 * Useful for comparing to a shape index. </i></DD>
 * <p>
 * <DT>java kps.frontend.gui.map.layer.shape.SpatialIndex -d -b file.ssx</DT>
 * <DD><i>Dumps spatial index information including bounding boxes to stdout.
 * </i></DD>
 * <p>
 * <DT>java kps.frontend.gui.map.layer.shape.SpatialIndex -c file.shp</DT>
...
public class SpatialIndex extends ShapeUtils {
    ...
    public static Logger logger = Logger.getLogger("kps.frontend.gui.map.layer.shape.SpatialIndex");
     ...
     * (non-Javadoc)
     * 
     * @see kps.frontend.gui.map.io.Closable#close(boolean)
     */

 ...
 *    openmap.Debug - Debug tokens to activate for printout.  @see kps.frontend.gui.map.util.Debug
 *   
...
public class Environment extends Properties {
    ...
    protected static void initRuntimeProperties(Properties p) {
        ...
        if (osname.equalsIgnoreCase("solaris")
            ...
            // isXWindows = false;
            // doingXWindowsWorkaround = false;
            kps.frontend.gui.map.omGraphics.DrawingAttributes.alwaysSetTextToBlack = true;
